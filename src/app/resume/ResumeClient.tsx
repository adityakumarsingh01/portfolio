...
export default function ResumeClient({ pdfUrl, imageUrl }: { pdfUrl: string, imageUrl: string }) {
  return (
    <main className="max-w-6xl mx-auto px-6 md:px-12 pt-24 pb-16 flex flex-col justify-center items-center" style={{ fontFamily: 'Cambria, serif' }}>
      ...
      <div className="w-full flex flex-col lg:flex-row gap-8 items-start">
        ...
        >
          <SpotlightCard className="p-8 border border-black/5 dark:border-white/5 rounded-[2rem] flex flex-col gap-8 sticky top-24">
            <div>
              <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2" style={{ fontFamily: 'Cambria, serif' }}>Quick Info</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Everything you need to know at a glance.</p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4 text-gray-700 dark:text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-xs">Actively looking for roles</p>
                </div>
              </div>
              <div className="flex items-center gap-4 text-gray-700 dark:text-gray-300">
                <div className="w-10 h-10 rounded-full bg-green-50 dark:bg-green-500/10 flex items-center justify-center flex-shrink-0 text-green-600 dark:text-green-400">
                  <CheckCircle2 className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Experience</p>
                  <p className="text-xs">Fresher</p>
                </div>
              </div>
              <div className="flex items-center gap-4 text-gray-700 dark:text-gray-300">
                <div className="w-10 h-10 rounded-full bg-red-50 dark:bg-red-500/10 flex items-center justify-center flex-shrink-0 text-red-600 dark:text-red-400">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Location</p>
                  <p className="text-xs">Remote / On-site</p>
                </div>
              </div>
            </div>
        ...
        >
          <SpotlightCard className="p-2 md:p-4 border border-black/5 dark:border-white/5 rounded-[2rem] group cursor-pointer relative overflow-hidden">
            <a href={pdfUrl} target="_blank" rel="noopener noreferrer" className="block relative overflow-hidden rounded-xl bg-white border border-gray-100 dark:border-gray-800 shadow-inner">
